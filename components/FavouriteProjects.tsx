        ...
        <div className="grid md:grid-cols-3 gap-8 lg:-mt-8 pb-40">
          ...
          >
            <div className="relative overflow-hidden">
              <img
                src="/amp-wordpress-plugin.webp"
                alt="Google AMP WordPress Plugin"
          ...
          {/* Single card */}
          <a
            href="https://www.youtube.com/c/FellyphCintra/featured"
            className="w-full block col-span-3  sm:col-span-1 shadow-2xl"
          >
            <div className="relative overflow-hidden">
              {/* <div className="overlay absolute inset-0 bg-black bg-opacity-70 z-10"></div> */}
              <img
                src="/canal-fellyph.webp"
                alt="Canal Fellyph"
                className="transform hover:scale-125 transition duration-2000 ease-out"
              />
              <h1 className="absolute top-10 left-10 text-gray-50 font-bold text-xl bg-red-500 rounded-md px-2">
                Canal Fellyph Cintra
              </h1>
              <h1 className="absolute bottom-10 left-10 text-gray-50 font-bold text-xl">
                02
              </h1>
          ...
          {/* Single card */}
          <a
            href="https://profiles.wordpress.org/fellyph/"
            className="w-full block col-span-3 sm:col-span-1 object-cover"
          >
            <div className="relative overflow-hidden shadow-2xl">
              {/* <div className="overlay absolute inset-0 bg-black bg-opacity-70 z-10"></div> */}
              <img
                src="/profile-wordpress-fellyph.webp"
                alt="portfolio"
                className="transform hover:scale-125 transition duration-2000 ease-out object-cover shadow-2xl"
              />
              <h1 className="absolute top-10 left-10 text-gray-50 font-bold text-xl bg-red-500 rounded-md px-2">
                WordPress contributor profile
              </h1>
              <h1 className="absolute bottom-10 left-10 text-gray-50 font-bold text-xl">
                03
              </h1>
           ...
           {/* Single card */}
           <a
            href="https://www.youtube.com/channel/UCu6DycMkhHF64HtB9nUaQiw/featured"
            className="w-full block col-span-3 sm:col-span-1 object-cover"
          >
            <div className="relative overflow-hidden shadow-2xl">
              {/* <div className="overlay absolute inset-0 bg-black bg-opacity-70 z-10"></div> */}
              <img
                src="/px-road-channel.webp"
                alt="portfolio"
                className="transform hover:scale-125 transition duration-2000 ease-out object-cover shadow-2xl"
              />
              <h1 className="absolute top-10 left-10 text-gray-50 font-bold text-xl bg-red-500 rounded-md px-2">
